...
карточками). У предметов/аддонов/подношений пока нет ручного русского
перевода описаний (только названия, где они есть) — показывается
английский текст с явной пометкой в карточке, честный fallback вместо
неточного авто-перевода.
